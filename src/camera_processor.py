...
class CameraProcessor:
    ...
    def process_image(self, image: np.ndarray) -> Tuple[torch.Tensor, None]:
        ...
        # Crop bottom of image to match CARLA preprocessing
        # Original Simlingo crops: rgb_pos[:int(rgb_pos.shape[0] - (rgb_pos.shape[0] * 4.8) // 16), :, :]
        # This removes the bottom ~30% of the image (hood/dashboard area)
