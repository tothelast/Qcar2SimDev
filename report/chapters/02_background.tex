...
\begin{itemize}[leftmargin=*,itemsep=0.25em]
  \item \textbf{Vision encoder}: InternViT-300M-448px, a 300\,M-parameter vision transformer pretrained at $448\times448$ resolution.
  \item \textbf{Language model}: Qwen2-0.5B-Instruct, a 500\,M-parameter causal language model.
\end{itemize}
