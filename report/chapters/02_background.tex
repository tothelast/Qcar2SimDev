...
In this repository, training is organized using PyTorch Lightning \citep{pytorchlightning} and accelerated with DeepSpeed ZeRO optimizations \citep{deepspeed}; hyperparameters and the relevant Hydra \citep{yadan2019hydra} configurations are recorded in Appendix \Cref{app:hyperparameters}.
