...
Evaluation is currently scenario-driven and limited to the scene and route definitions included in the repository (\Cref{app:scene-configs}). While this enables repeatable comparisons, it does not guarantee generalization to unseen layouts, different actor behaviors, or substantial appearance changes.
