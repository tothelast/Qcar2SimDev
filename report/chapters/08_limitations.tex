...
Evaluation is currently scenario-driven and limited to the scene and route definitions included in the repository (\Cref{app:scene-configs}). While this enables reproducible comparisons, it does not guarantee generalization to unseen layouts, different actor behaviors, or substantial appearance changes.
...
\begin{itemize}[leftmargin=*,itemsep=0.25em]
  ...
  \item \textbf{Sim-to-real \citep{tobin2017domain} (optional):} evaluate whether the same interface and control conversion can be transferred to physical QCar~2 hardware with appropriate safety constraints.
\end{itemize}
