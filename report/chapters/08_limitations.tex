...
As a direct consequence, the quantitative results reported in \Cref{ch:results} use obstacle placements and route geometry that overlap with the training data distribution. While this demonstrates that the fine-tuned model functions correctly on the adapted domain, it does not constitute a held-out generalization test. A stricter evaluation protocol would test on unseen obstacle positions, route topologies, or visual conditions not represented during fine-tuning.
