...
The guiding principle is \emph{distribution alignment}: the inference-time signals should match the training-time data format as closely as possible. In this repository the most important alignment targets are:
...
\begin{table}[h]
\centering
\caption{Implementation-relevant differences between learning to drive in CARLA and QLabs for this project.}
